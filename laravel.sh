...
sudo apt-get install libapache2-mod-php php php-common php-xml php-mysql php-gd php-mbstring php-tokenizer php-json php-bcmath php8.1 php-curl php-zip unzip -y < /dev/null
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=eminent/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=eminent/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=eminent007/' /var/www/html/laravel/.env
