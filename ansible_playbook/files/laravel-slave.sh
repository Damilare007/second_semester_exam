...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=nike/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=nike/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=nike007/' /var/www/html/laravel/.env
